    ...
    return (
        <div className="w-52 sticky top-20 h-[calc(100vh-4rem)] p-3 flex flex-col flex-shrink-0 bg-mint-500">
            ...
            <div className=" flex-1 flex flex-col justify-start mb-10 rounded-md border border-lime-800 bg-mint-200 shadow-md/30">
                <button className="line-through m-2 py-2 rounded-xl font-semibold bg-buttonGray shadow-md/30 hover:bg-neutral-300">Add New Order</button>
                <button className="m-2 py-2 rounded-xl font-semibold bg-buttonGray shadow-md/30 hover:bg-neutral-300">Add Med Order</button>
                <button  className="m-2 py-2 rounded-xl font-semibold bg-buttonGray shadow-md/30 hover:bg-neutral-300">Add Lab Result</button>
                <button  className="m-2 py-2 rounded-xl font-semibold bg-buttonGray shadow-md/30 hover:bg-neutral-300">Submit Items</button>
            </div>
        </div>
    )
}
