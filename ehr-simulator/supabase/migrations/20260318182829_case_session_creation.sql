...
-- Course cases and courses
-- ALTER TABLE course_cases RENAME COLUMN IF EXISTS case_data_id TO cases_id;

-- ALTER TABLE section_assignments RENAME COLUMN IF EXISTS case_data_id TO cases_id;

-- ALTER TABLE case_sessions RENAME COLUMN IF EXISTS case_data_id TO cases_id;
