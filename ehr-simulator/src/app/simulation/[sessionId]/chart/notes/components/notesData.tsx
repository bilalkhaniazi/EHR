...
// export interface StudentNote extends ClinicalNote {
//   title: "Student Note";
//   content: SbarNote;
// }

// interface TextNote extends ClinicalNote {
//   title: string;
//   noteBody: string;
// }

// export interface ProviderNote extends ClinicalNote {
//   title: string;
...
export const sampleNotes: ClinicalNote[] = [
  {
    ...
    content: `
    Patient continues to report improvement in energy and overall well-being. Foot numbness persists. Right great toe ulcer has no new pain. 
    Patient verbalizes understanding of diabetes management and wound care principles. Temp: 36.9°C, HR: 78 bpm, BP: 128/76 mmHg, RR: 16/min, 
    SpO₂: 98% RA. Right great toe ulcer: 2x2 cm, clean base, good granulation. Erythema nearly resolved. No drainage or odor. Left foot: no changes. 
    Lungs clear, heart RRR. Daily BMP stable. 60-year-old male, T2DM with infected right great toe ulcer. Significant improvement in local infection signs and systemic symptoms.
     Glycemic control is improving. Patient is stable and trending towards discharge. 1. Continue current medical regimen and wound care. 2. Continue daily BMP until 3 days are complete.
      3. Continue to encourage progressive ambulation and deep breathing. 4. Case management consult to finalize home health services for wound care post-discharge. Daughter contacted and prepared for discharge.
       5. Discuss discharge plan with patient, including medication reconciliation, follow-up with PCP and Podiatry, and signs of worsening infection. 6. Aim for discharge by end of day if home health is
        confirmed and patient remains stable on room air with good functional mobility.
    `,
  ...
  },
  {
    ...
    content: 'Patient reports decreased fatigue, improved energy. Numbness in feet remains unchanged. Right great toe ulcer without new pain. Reports good appetite today, tolerating diabetic diet. No fever or chills.',
    excludedFromPresim: true
  },
  {
    title: "Nursing Note",
  ...
  },
  {
    ...
    content: 'Patient reports chronic foot numbness. Ulcer present for approx. 1 week, gradual onset of redness. Denies purulent drainage at home. Reports difficulty checking foot due to limited mobility. Primary concern is healing and preventing further complications.',
